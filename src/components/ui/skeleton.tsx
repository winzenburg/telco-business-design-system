...
function Skeleton({
  ...
  return (
    <div
      className={cn(
        "animate-pulse rounded-[4px] bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 bg-[length:200%_100%]",
        "animate-[shimmer_1.5s_ease-in-out_infinite]",
        className
      )}
      style={{
        backgroundImage: 'linear-gradient(90deg, #F1F2F6 25%, #FFFFFF 50%, #F1F2F6 75%)',
