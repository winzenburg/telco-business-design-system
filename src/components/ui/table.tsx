...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'h-12 px-4 text-left align-middle font-primary font-semibold text-[var(--ds-color-text-primary)] whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-0.5',
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<'td'>) {
  return (
    <td
      ...
      className={cn(
        'px-4 py-3 align-middle font-secondary text-[var(--ds-color-text-secondary)] whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-0.5',
        className,
      )}
      {...props}
    />
