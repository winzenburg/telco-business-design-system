...
<Meta title="Documentation/Forms/DatePicker" />
...
```
┌─────────────────────────────────────────┐
│ MM/DD/YYYY                          📅  │ Input + Icon
└─────────────────────────────────────────┘
  ↓ (Opens calendar)
┌─────────────────────────────────────────┐
│  < January 2024                      >  │ Month navigation
├─────────────────────────────────────────┤
...
### When to Use
- ✅ Selecting specific dates (appointments, events)
- ✅ Date range filtering (start/end dates)
- ✅ Birth dates or historical dates
- ✅ Future date scheduling
- ✅ Any scenario where date format errors are common

### When NOT to Use
- ❌ Year-only selection (use Select or Input)
- ❌ Relative dates ("yesterday", "last week" - use preset buttons)
- ❌ Very distant past/future (> 10 years - consider manual entry)
...
### Color Contrast
- ✅ Text: neutral-900 on white (21:1 - AAA)
- ✅ Selected date: white on primary-600 (4.5:1 - AA)
- ✅ Today indicator: meets contrast requirements
- ✅ Error text: destructive red (4.5:1 - AA)
